...
- [x] 1. Инициализировать структуру проекта
...
- [x] 2. Поднять базовый Node.js + Socket.io сервер
...
- [x] 3. Реализовать серверную валидацию и нормализацию пользовательского ввода
...
- [x] 4. Реализовать in-memory `roomStore`
...
- [x] 5. Реализовать атомарный вход в комнату и лимит 4 участников
...
- [x] 6. Реализовать серверный lifecycle выхода и disconnect
...
- [x] 7. Реализовать серверные системные события участников
...
- [x] 8. Реализовать серверный текстовый чат
...
- [x] 9. Реализовать маршрутизацию WebRTC signaling на сервере
...
- [x] 10. Реализовать серверное обновление media-state
...
- [x] 11. Инициализировать React-приложение и маршрутизацию
...
- [x] 12. Реализовать стартовый экран и валидацию имени на клиенте
...
- [x] 13. Реализовать создание комнаты и вход по ссылке на клиенте
...
- [x] 14. Реализовать `useSocketRoom`
...
- [x] 15. Реализовать `useLocalMedia`
...
- [x] 16. Реализовать управление микрофоном
...
- [x] 17. Реализовать управление камерой с освобождением устройства
...
- [x] 18. Реализовать `usePeerConnections`
...
- [x] 19. Реализовать WebRTC offer/answer flow для нового участника
...
- [x] 20. Реализовать экран комнаты и базовый layout
...
- [x] 21. Реализовать видеосетку и плитку участника
...
- [x] 22. Реализовать панель управления комнатой
...
- [x] 23. Реализовать чат на клиенте
...
- [x] 24. Реализовать список участников
...
- [x] 25. Реализовать обработку заполненной комнаты и повтор входа
...
- [x] 26. Реализовать UX для permission, autoplay и media errors
...
- [x] 27. Покрыть сервер unit tests
...
- [x] 28. Покрыть Socket.io integration tests
...
- [x] 29. Покрыть клиентские unit tests
...
- [x] 30. Добавить Playwright E2E smoke tests
...
- [x] 31. Добавить E2E/ручные проверки медиа-сценариев
...
- [x] 32. Подготовить production build и запуск
...
- [x] 33. Добавить README с запуском и QA checklist
